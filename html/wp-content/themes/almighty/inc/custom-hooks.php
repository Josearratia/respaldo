...
if ( ! function_exists( 'almighty_render_layout_option_metabox' ) ) :
    ...
    function almighty_render_layout_option_metabox( $post, $metabox ) {
        ...
        <div id="pb_metabox-container" class="pb-metabox-container">
            <div id="pb-metabox-layout" class="almighty-opt-switch">
                <label class="almighty-label-text"> <?php _e('Disable Featured Image on single page', 'almighty') ?></label>
                <input type="checkbox" name="almighty-meta-checkbox" id="almighty-meta-checkbox" value="yes" <?php if (isset ($almighty_post_meta_value['almighty-meta-checkbox'])) checked($almighty_post_meta_value['almighty-meta-checkbox'][0], 'yes'); ?> />
                <label for="almighty-meta-checkbox" class="almighty-checkbox-label"></label>
            </div>
        </div>
